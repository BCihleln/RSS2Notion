...
from .notion.subscription import get_avaliable_subscriptions, handle_subscription_failure
...
if __name__ == "__main__":
    ...
    with ThreadPoolExecutor(max_workers=max_workers) as executor:
        ...
        for future in as_completed(futures):
            ...
            if isinstance(fetch_result, Exception):
                handle_subscription_failure(client, fetched_subscirption, str(fetch_result))
